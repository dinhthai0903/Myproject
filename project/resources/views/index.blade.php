...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('resoures/css/style1.css')}}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-dark" type="submit">
                            ...
                            <a style="text-decoration: none;" href="/cart">Cart</a>
                            
                            <span class="badge bg-dark text-white ms-1 rounded-pill">0</span>
                        </button>
                </form>
                <form style="margin-left: 0.5cm;" class="d-flex">

                    <button class="btn btn-outline-dark" type="submit"> <a class="admin" href="/login-2">Admin</a> </button>
                </form>
                <div style="margin-left: 0.5cm;" class="login-box">
                    <a style="color:rgb(14, 78, 134);" href="/register">Register</a>
                    <a style="color:rgb(14, 78, 134);" href="/login">Login</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Technology shopping in your favorites</h1>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder">SmartWatch Full 4K</h5>
                                <!-- Product reviews-->
                                <div class="d-flex justify-content-center small text-warning mb-2">
                                    <div class="bi-star-fill"></div>
                                    <div class="bi-star-fill"></div>
