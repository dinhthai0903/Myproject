...
<body onload="time()">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="" data-toggle="tooltip" data-placement="bottom" title="ĐIỂM DANH">ATTENDANCE</a></li>
                    <li><a href="" data-toggle="tooltip" data-placement="bottom" title="TIỀN LƯƠNG">SALARY</a></li>
                    <li><a href="" data-toggle="tooltip" data-placement="bottom" title="LỊCH CÔNG TÁC">WORKING SCHEDULE</a>
                    </li>
                    <li><a href="#contact" data-toggle="tooltip" data-placement="bottom" title="BÁO CÁO">REPORT</a>
                    </li>
                    <li><a href="#tour" data-toggle="tooltip" data-placement="bottom" title="SỰ KIỆN">EVENT</a></li>
                    <li>
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="TÀI KHOẢN"><b>Account</b>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown">
                            <li><a href="/index.html" data-toggle="tooltip" data-placement="bottom"
                                    title="ĐĂNG XUẤT"><b>Log out <i class="fas fa-sign-out-alt"></i></b></a></li>
                        </ul>
                    </li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>EMPLOYEE SEARCH:</b></p><Br><Br>
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter employee name...">
        ...
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
            title="Add Staff"><i class="fas fa-user-plus"></i></button>
        <button class="nv" type="button" onclick="sortTable()" data-toggle="tooltip" data-placement="top"
            title="Filter the data"><i class="fa fa-filter" aria-hidden="true"></i></button>
        <button class="export staff" data-toggle="tooltip" data-placement="top" title="export File"><i
        ...
        <table class="table table-bordered" id="myTable">
            <thead>
                <tr class="ex">
                    <th width="auto">Staff's name</th>
                    <th width="auto">Sex</th>
                    <th>Date of birth</th>
                    <th>Address</th>
                    <th>Position</th>
                    <th width="5px; !important">Feature</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>Nguyen Huu Long</td>
                    <td>male</td>
                    <td>21/10/2003</td>
                    <td>12 Thai Thi Boi, Thanh Khe, Da Nang</td>
                ...
                <tr>
                    <td>Nguyen Dinh Thai</td>
                    <td>male</td>
                    <td>12/02/1999</td>
                    <td>192/12b Thai Thi Boi, Thanh Khe, Da Nang</td>
                ...
                <tr>
                    <td>Nguyen Tuan Vu</td>
                    <td> male</td>
                    <td>07/10/1997</td>
                    <td>10 Nguyen Luong Bang, Tan Phu, District 7, Ho Chi Minh</td>
                ...
                <tr>
                    <td>Tran Thi Duyen</td>
                    <td>Female</td>
                    <td>22/12/1999</td>
                    <td>3 Hoa Binh, Ward 3, District 11, Ho Chi Minh</td>
                ...
                <tr>
                    <td>Truong Thi Hoa</td>
                    <td>Female</td>
                    <td>02/06/1998</td>
                    <td>19 Nguyen Huu Tho Street, Tan Hung, District 7, Ho Chi Minh</td>
                ...
                <tr>
                    ...
                    <td>Female</td>
                    <td>06/04/1998</td>
                    <td>13, Tan Thuan Dong, District 7, Ho Chi Minh City</td>
                    <td>Service</td>
                    <td>
                        <a class="add" title="Lưu Lại" data-toggle="tooltip"><i class="fa fa-floppy-o"
                                aria-hidden="true"></i></a>
                ...
                <tr>
                    <td>Nguyen Thi Ngoc Anh</td>
                    <td>Female</td>
                    <td>23/07/1996</td>
                    <td>121/21 Quang Trung, Thanh Khe, Da Nang </td>
                    <td>Service</td>
                    <td>
                        <a class="add" title="Lưu Lại" data-toggle="tooltip"><i class="fa fa-floppy-o"
                                aria-hidden="true"></i></a>
