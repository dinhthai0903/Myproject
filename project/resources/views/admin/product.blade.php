...
<body onload="time()">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i>Product Manager</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#home" data-toggle="tooltip" data-placement="bottom"
                            title="STAFF">PRODUCT</a></li>
    ...
    <div class="container-fluid al">
        <div id="clock"></div>
        <Br>
        <p class="timkiemnhanvien"><b>PRODUCT SEARCH:</b></p><Br><Br>
        ...
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top"
            title="Add Product"><i class="fas fa-user-plus"></i></button>
        ...
        <button class="export product" data-toggle="tooltip" data-placement="top" title="export File"><i
        ...
        <table class="table table-bordered" id="myTable">
            <thead>
                <tr class="ex">
                    <th width="auto">Product's name</th>
                    <th width="auto">Id</th>
                    <th>Date Added</th>
                    <th>Image</th>
                    <th>number</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>00001</td>
                    <td>01/08/2023</td>
                    <td><img width="100px" src="{{ asset('image/danh-gia-tivi-lg-2.jpg') }}" alt=""></td>
                ...
                <tr>
                    ...
                    <td>00002</td>
                    <td>01/08/2023</td>
                    <td><img width="100px" src="{{ asset('image/oppo-watch-10.jpg') }}" alt=""></td>
                ...
                <tr>
                    ...
                    <td>00003</td>
                    <td>01/08/2023</td>
                    <td><img width="100px" src="{{ asset('image/hang-laptop-dell-cua-nuoc-nao.jpg') }}" alt=""></td>
                ...
                <tr>
                    ...
                    <td>00004</td>
                    <td>01/08/2023</td>
                    <td><img width="100px" src="{{ asset('image/Xiaomi-redmi-note-11-blue-600x600.jpg') }}" alt=""></td>
